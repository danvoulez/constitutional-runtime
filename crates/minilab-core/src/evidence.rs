...
impl EvidenceKind {
    ...
    // Reconcile-shaped state convergence: plan drift, apply bounded steps,
    // then close as reconciled or failed. This is intentionally distinct from
    // the single-act slice anatomy used by outbound.send and host.pair.
