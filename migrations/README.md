...
| `010_host_pairing_slice.sql` | Add minimal host substrate for `host.pair` |
| `011_install_reconcile_slice.sql` | Add minimal installation substrate for `install.reconcile` |
